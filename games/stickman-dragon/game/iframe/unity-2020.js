!function(n) {
    ...
    var i = {
        ...
        maxRatio: 16 / 9,
        minRatio: 9 / 16,
        thumbnail: "https://img.com/cdn-cgi/image/quality=80,width=100,height=100,fit=cover,g=0.5x0.5,f=auto/a398cd4e645b76810031bd97f8697414.png",
        numScreenshots: 4,
...
, function(n, e, t) {
    ...
    e.a = r;
    var m, p, g, w, v, y, b = t(10), x = t.n(b), S = t(0), L = "image", k = 0, E = !1, I = S.a.screenshotsVersion ? "?v".concat(S.a.screenshotsVersion) : "", T = window.location.pathname.substring(0, window.location.pathname.lastIndexOf("/")), C = window.location.hostname.endsWith("game-cdn.com") || window.location.hostname.endsWith(".poki-gdn.com"), B = C ? "/cdn-cgi/image/f=auto,quality=78".concat(T, "/") : "";
...
, function(n, e, t) {
    ...
    d.title = r.a.title;
    var u = r.a.thumbnail;
    u.startsWith("https://img.com/") && (u = "https://img.com/cdn-cgi/image/quality=78,width=40,height=40,fit=cover,g=0.5x0.5,f=auto/".concat(u.substr(21))),
    d.src = u;
