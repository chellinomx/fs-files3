(() => {
        ...
        o = {
                    ...
                    function e(t) {
                        ...
                        (this.gameStarted = !1),
                            ...
                            (this.setDebug = function (e) {
                                ...
                                t.endsWith("poki-gdn.com") || "qa-files.com" === t ? e && o.Z.track(i.Z.tracking.debugTrueInProduction) : ((d.Z.debug = e), (d.Z.log = null != e ? e : d.Z.log), e ? (0, s.lF)() : (0, s.MT)());
                            }),
                            ...
                            return (
                                ...
                                new Promise(function (n) {
                                    t.monetization.init(
                                        ...
                                        r.Z.sendMessage(i.Z.message.sdkDetails, { version: "41e433a362a29d8fbbb07657e5ca5c3bb031ddec" });
                                })
                            );
                        }),
                            ...
                            return o(this, void 0, void 0, function () {
                                ...
                                return r(this, function (n) {
                                    switch (n.label) {
                                        ...
                                        case 1:
                                            return (t.cookies = n.sent()), (t.p4d_game_id = i.Z.gameID), (t.user_id = s), (e = t), window.fetch("https://t.io/game-cookies", { method: "post", body: JSON.stringify(e) }).catch(), [3, 3];
                                        case 2:
                                            return n.sent(), [3, 3];
                                        case 3:
                                            return [2];
                            ...
                            return ve(this, function (r) {
                                switch (r.label) {
                                    case 0:
                                        return (
                                            (t = e.screenshot),
                                            "https://api.io/screenshot",
                                            (n = "https://poki-user-content.com/"),
                                            [4, fetch("https://api.io/screenshot", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ data: t }) })]
                                        );
                                    case 1:
                                        (i = r.sent()), (r.label = 2);
                                    case 2:
                                ...
                                switch (I.label) {
                                    case 0:
                                        return (
                                            ...
                                            (a.src = "https://a.com/images/screenshot-frame.png"),
                                            ...
                                            128,
                                            (d.src = "https://img.com/cdn-cgi/image/quality=78,width=".concat(128, ",height=").concat(128, ",fit=cover,f=auto/").concat(i)),
                                            (l = new FontFace("TorusBold", "url(fonts/torus-bold-latin.woff2)")),
                                            (u = l.load()),
            ...
            453: (e, t, n) => {
                ...
                function a(e, t, n) {
                    ...
                    })("https://t.io/l", JSON.stringify({ c: "observer-error", ve: 7, d: i }));
                }
                        ...
                        (e.init = function (t, n) {
                            ...
                            void 0 === t &&
                                ("test" === (null === (r = null === (o = null === window || void 0 === window ? void 0 : window.process) || void 0 === o ? void 0 : o.env) || void 0 === r ? void 0 : r.NODE_ENV)
                                    ...
                                    ? ((t = !0), void 0 === n && (n = !1))
                                    : ((t = !1), void 0 === n && (n = !1))),
                                i.Z.isInspector || "qa-files.com" === a ? ((t = !0), (n = !0)) : a.endsWith(".poki-gdn.com") && ((t = !1), (n = !1)),
                                i.Z.debugMode && (t = !0),
                                i.Z.logMode && (n = !0),
                                void 0 === n && (n = t),
                                (e.debug = t),
            ...
            902: (e, t, n) => {
                ...
                const s = function (e) {
                    ...
                    if ("undefined" != typeof window && "undefined" != typeof fetch) {
                        ...
                        i.Z.debug ? console.log("PokiAdServer Tracking: ", d) : fetch("https://t.io/adserver", { method: "POST", mode: "no-cors", body: JSON.stringify(d) });
                    }
                };
            },
            888: (e, t, n) => {
                ...
                var s,
                    ...
                    l = {
                        ...
                        isInspector:
                            ...
                            (null === (d = null === document || void 0 === document ? void 0 : document.referrer) || void 0 === d ? void 0 : d.includes("inspector.dev")) ||
                            "1" === (0, o.Z)("inspector"),
    ...
    (a.m = o),
        ...
        (() => {
            ...
            function U() {
                var e = "https://api.com/ads/houseads/video/vast";
            ...
            function Ae() {
                ...
                return "yes" === (0, M.Z)("poki-ad-server") ? (console.log("DEBUG: Only running Poki-ad-server"), !0) : ("localhost" === t || "game-cdn.com" === t || t.endsWith(".poki-gdn.com"), !1);
            }
            var he,
                fe = !1,
                me = n.Z.testVideos,
            ...
            var Ee = "pokiSdkContainer",
                ...
                Ne = "\n."
                    ...
                    .concat(
                        Re,
                        " {\n\tz-index: 10;\n\tposition: absolute;\n\ttop: 0;\n\tleft: 0;\n\twidth: 100%;\n\theight: 100%;\n\tbackground: url('https://a.com/images/thumb_anim_2x.gif') 50% 50% no-repeat;\n\tuser-select: none;\n}\n\n."
                    )
                    .concat(
                        Se,
                    ...
                    (t.prototype.onAdEvent = function (t) {
                        ...
                        switch (t.type) {
                            ...
                            case google.ima.AdEvent.Type.IMPRESSION:
                                T.Z.dispatchEvent(e.Z.ads.impression, { creativeId: i.getCreativeId() });
                        }
                    }),
            ...
            const Xe = function () {
                ...
                var t = encodeURIComponent("".concat(window.location.protocol, "//").concat(window.location.host).concat(e).concat(window.location.search)),
                    ...
                    i = "https://devs-api.com/gameinfo/@sdk?href=".concat(t, "&referrer=").concat(n);
            ...
            function Ye() {
                return Je(this, void 0, void 0, function () {
                    ...
                    return Ke(this, function (o) {
                        switch (o.label) {
                            case 0:
                                return o.trys.push([0, 3, , 4]), [4, fetch("https://geo.io/", { method: "GET", headers: { "Content-Type": "text/plain" } })];
                            case 1:
                    ...
                    return et(this, function (s) {
                        switch (s.label) {
                            case 0:
                                ...
                                s.label = 1;
                            case 1:
                                return s.trys.push([1, 4, , 5]), [4, fetch("https://api.com/ads/settings", { method: "GET", headers: { "Content-Type": "application/json" } })];
                            case 2:
                    ...
                    (this.slotMap = new Map()),
                        ...
                        (this.requestHouseAd = function (i, o) {
                            ...
                            (0, D.Z)(nt(nt({}, r), { event: "request" })),
                                fetch("https://api.com/ads/houseads/display/".concat(i.width, "x").concat(i.height, "?game_id=").concat(n.Z.gameID, "&site=").concat(n.Z.siteID))
                                    .then(function (e) {
                                        return e.json();
                                    })
                                    .then(function (n) {
                                        ...
                                        case 2:
                                            return (
                                                ...
                                                n.Z.familyFriendly || n.Z.nonPersonalized
                                                    ...
                                                    : w.push((0, b.Z)("https://a.com/prebid/prebid8.36.0-2.js"), (0, b.Z)("https://c.amazon-adsystem.com/aax2/apstag.js")),
                                    ...
                                    if (
                                        ...
                                        if (y === e.Z.ads.position.rewarded || vt.requestPossible())
                                            if (y !== e.Z.ads.position.rewarded && this.adSettings.countryExclusion.includes(n.Z.country)) T.Z.dispatchEvent(e.Z.ads.limit, At(At({}, b), { reason: e.Z.info.messages.disabled }));
                                                ...
                                                else if (v()) T.Z.dispatchEvent(e.Z.ads.error, At(At({}, b), { messaage: "No TCFv2 CMP detected, please contact developersupport@com for more information" }));
                                                else if (g()) T.Z.dispatchEvent(e.Z.ads.error, At(At({}, b), { messaage: "No USP detected, please contact developersupport@com for more information" }));
                            ...
                            return (
                                ...
                                !n.Z.kioskMode &&
                                    (i.Z.debug
                                        ...
                                        : v()
                                        ? (T.Z.dispatchEvent(e.Z.ads.error, { message: "No TCFv2 CMP detected, please contact developersupport@com for more information" }), !1)
                                        : g()
                                        ? (T.Z.dispatchEvent(e.Z.ads.error, { message: "No USP detected, please contact developersupport@com for more information" }), !1)
                                        : r
                                        ? this.sdkBooted
                                            ? o
